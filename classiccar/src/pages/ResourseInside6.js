  ...
  return (
    <div>
      ...
      <section className="first-section-inside">
        ...
        <h1>Safe-n-Secure™ Transaction Resources</h1>
        <h6>
          Safe-n-Secure™ is a comprehensive and exclusive system of policies and
          procedures that help shield ClassicCars.com buyers and sellers from
          fraud. The company below offers services that can help to ensure a
          safe and secure transaction when buying or selling a classic car.
        </h6>
      </section>

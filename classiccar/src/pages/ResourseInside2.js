  ...
  return (
    <div>
      ...
      <section className="first-section-inside">
        ...
        <h1>Inspection & Appraisal Resources</h1>
        <h6>
          You found the perfect classic! At least you think you did. How can you
          be sure when the car is in a different state? Or maybe you know
          everything about your favorite model- except the current market value.
          ClassicCars.com can help. Hire an inspection service or appraiser that

...
<div className={s.dealer}>
  ...
  <div className={s.setting}>
    <IoMdSettings className={s.set} /><h3>24/7 Inventory exposure to over 4+ million monthly visitors</h3>
    </div>
<div className={s.setting}>
  <IoMdSettings className={s.set} /><h3>Trusted by over 500 modern and classic car dealers</h3>
  </div>
<div className={s.setting}>
<IoMdSettings className={s.set}/><h3>Qualified leads to turn inventory faster</h3>
</div>
<div className={s.setting}>
  <IoMdSettings className={s.set}/><h3> No contract, month to month agreement</h3>
  </div>
<div className={s.setting}>
